...
export default function TeamCollaboration({ formState, updateFormData }: TeamCollaborationProps) {
  const showFollowUp = formState.question1 === "1"; // Show follow-up when user selects "1" (反感)
  
  // Get image based on user group
  const imageSrc = formState.userGroup 
    ? getImageForPage(formState.userGroup, 2) // This is page 2 (first form page after registration)
    : "/placeholder.jpg";
          ...
          >
            <div className="space-y-2">
              <div className="flex items-center">
                ...
                />
                <Label htmlFor="q1-0" className="ml-2 text-gray-700">
                  0：正常
                </Label>
              </div>
              <div className="flex items-center">
                <RadioGroupItem 
                  ...
                  className="text-[#4F7B6E] focus:ring-[#4F7B6E]"
                />
                <Label htmlFor="q1-1" className="ml-2 text-gray-700">
                  1：反感
                </Label>
              </div>
            </div>
