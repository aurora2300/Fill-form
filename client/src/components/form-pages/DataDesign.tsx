...
export default function DataDesign({ formState, updateFormData }: DataDesignProps) {
  const showFollowUp = formState.question5 === "1"; // Show follow-up when user selects "1" (反感)
  
  // Get image based on user group
  const imageSrc = formState.userGroup 
    ? getImageForPage(formState.userGroup, 6) // This is page 6 (fifth form page after registration)
    : "/placeholder.jpg";
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="mb-6">
          ...
          <RadioGroup
            value={formState.question5 || ""}
            onValueChange={(value) => updateFormData("question5", value)}
          >
            <div className="space-y-2">
              <div className="flex items-center">
                ...
                />
                <Label htmlFor="q5-0" className="ml-2 text-gray-700">
                  0：正常
                </Label>
              </div>
              <div className="flex items-center">
                <RadioGroupItem 
                  ...
                  className="text-[#4F7B6E] focus:ring-[#4F7B6E]"
                />
                <Label htmlFor="q5-1" className="ml-2 text-gray-700">
                  1：反感
                </Label>
              </div>
            </div>
