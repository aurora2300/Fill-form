...
export default function DesignSystem({ formState, updateFormData }: DesignSystemProps) {
  const showFollowUp = formState.question4 === "1"; // Show follow-up when user selects "1" (反感)
  
  // Get image based on user group
  const imageSrc = formState.userGroup 
    ? getImageForPage(formState.userGroup, 5) // This is page 5 (fourth form page after registration)
    : "/placeholder.jpg";
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="mb-6">
          ...
          <RadioGroup
            value={formState.question4 || ""}
            onValueChange={(value) => updateFormData("question4", value)}
          >
            <div className="space-y-2">
              <div className="flex items-center">
                ...
                />
                <Label htmlFor="q4-0" className="ml-2 text-gray-700">
                  0：正常
                </Label>
              </div>
              <div className="flex items-center">
                <RadioGroupItem 
                  ...
                  className="text-[#4F7B6E] focus:ring-[#4F7B6E]"
                />
                <Label htmlFor="q4-1" className="ml-2 text-gray-700">
                  1：反感
                </Label>
              </div>
            </div>
